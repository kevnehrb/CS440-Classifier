...
def enhancedFeatureExtractorDigit(datum):
  ...
  ## DESCRIBE YOUR ENHANCED FEATURES HERE...
    ...
    Finding blank boxes: Divides the picture into 12 boxes, if there is a filled in pixel in the box, it is 0, otherwise it is 1
  ...
  for i in range(12):
    for x in range(DIGIT_DATUM_WIDTH/12):
        for y in range(DIGIT_DATUM_HEIGHT/12):
